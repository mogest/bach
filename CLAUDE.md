...
- `bach clip [--to <name>]` — save the host clipboard (text or image) as a file in a running session's `/shared` dir and copy the in-container path to the clipboard for pasting into claude.
